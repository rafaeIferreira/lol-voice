...
declare class ListUpdate extends Message<ListUpdate> {
   ...
   *
   * @generated from field: repeated string del = 3;
   */
  del: string[];
...
declare class TrackInfo extends Message<TrackInfo> {
   ...
   *
   * @generated from field: uint32 width = 5 [deprecated = true];
   * @deprecated
   */
  width: number;
   ...
   *
   * @generated from field: uint32 height = 6 [deprecated = true];
   * @deprecated
   */
  height: number;
