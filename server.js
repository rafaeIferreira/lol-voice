...
import { AccessToken } from 'livekit-server-sdk'  // <— pacote correto
...
app.post('/join', async (req, res) => {
  try {
    console.log('JOIN body:', req.body); // 🔎 debug
    ...
    // ✅ Use assinatura compatível: (apiKey, apiSecret, options)
